...
def main(args):
    ...
    #                                                 threshold=args.scheduler_th, threshold_mode='abs',
    #                                                 min_lr=args.scheduler_min_lr)

    # Load and preprocess the dataset
    # train_data = get_dataset('data/train.pt')
    # val_data = get_dataset('data/val.pt')
    ...
    for epoch in range(1, args.epochs):
        ...
        if epoch % args.check_val_epoch == 0:
            ...
            if val_loss < min_val_loss:
                ...
                torch.save(model, f'{args.checkpoint_dir}/bbox2activity_best.pt')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--scheduler_min_lr', type=float, default=0.00001)
    parser.add_argument('--scheduler_th', type=float, default=0.1)
    parser.add_argument('--scheduler_patience', type=int, default=75)
