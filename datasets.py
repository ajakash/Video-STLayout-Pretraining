...
def build_dataset(is_train, test_mode, args):
    if args.data_set == 'Kinetics-400':
        ...
        if is_train is True:
            ...
            box_data_path = os.path.join('data_VideoSTLayoutPT/train_val_sact.pt')
        elif test_mode is True:
            mode = 'test'
            anno_path = os.path.join('annotations/test_sact.csv')
        else:  
        ...
        if is_train is True:
            mode = 'train'
            anno_path = os.path.join('annotations/train_val_sact.csv')
            box_data_path = os.path.join('data_VideoSTLayoutPT/detection_data_min10boxes/train_val.pt')
        elif test_mode is True:
            mode = 'test'
            anno_path = os.path.join('annotations/test_sact.csv')
        else:  
